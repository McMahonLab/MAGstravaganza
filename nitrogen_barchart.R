...
me.counts <- c(27, 19, 53, 7, 65, 149, 168)
tb.counts <- c(128, 69, 80, 43, 24, 141, 151)
...
ggplot(data = ME.plot, aes(x = genes, y = me.counts)) + geom_bar(stat = "identity", fill = "#88419d", color = "black") + labs(x = "", y = "") + coord_flip() + scale_y_reverse(limits = c(170, 0))

ggplot(data = TB.plot, aes(x = genes, y = tb.counts)) + geom_bar(stat = "identity", fill = "#02818a", color = "black") + labs(x = "", y = "") + coord_flip() + ylim(0, 170)
